  ...
  return (
    <main className="min-h-[100dvh] bg-ink text-muted">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <h1 className="text-2xl font-black text-fg mb-6">Datenschutzerklärung</h1>
        ...
        <h2 className="text-lg font-bold text-fg mt-6 mb-2">Welche Daten wir verarbeiten</h2>
        <p className="mb-3 leading-relaxed text-sm">
        ...
        <p className="mb-3 leading-relaxed text-sm">
          ...
          Weitere Informationen: <span className="text-accent-bright">https://www.anthropic.com/privacy</span>.
        </p>

        <h2 className="text-lg font-bold text-fg mt-6 mb-2">Speicherung &amp; Löschung</h2>
        <p className="mb-3 leading-relaxed text-sm">
        ...
        <p className="mb-3 leading-relaxed text-sm">
          ...
          zertifiziert. Weitere Informationen: <span className="text-accent-bright">https://stripe.com/de/privacy</span>.
        </p>

        <h2 className="text-lg font-bold text-fg mt-6 mb-2">Rechtsgrundlage</h2>
        <p className="mb-3 leading-relaxed text-sm">
        ...
        <h2 className="text-lg font-bold text-fg mt-6 mb-2">Ihre Rechte</h2>
        <p className="mb-3 leading-relaxed text-sm">
